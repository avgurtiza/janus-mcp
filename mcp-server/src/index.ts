...
const semanticSearchInputSchema = fromJsonSchema<{ query: string; topK?: number }>({
  type: "object",
  properties: {
    query: { type: "string" },
    topK: { type: "number" },
...
const reindexInputSchema = fromJsonSchema<{ projectPath: string }>({
  type: "object",
  properties: {
...
const reindexOutputSchema = fromJsonSchema<{ fileCount: number }>({
  type: "object",
  properties: {
